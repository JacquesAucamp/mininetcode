...
def run():
    ...
    print('Link 1: \n')
    print('The percentage packet loss is: %d \n' %link1_int_received_pack_perc)
    print('The average RTT is: %.3f ms \n' %link1_int_avg_rtt)
