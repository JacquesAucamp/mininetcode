...
class Net_Topology(Topo):
    ...
    def build(self, k = 2):
        ...
        self.addLink(h1, s1, cls=TCLink, bw=sys.argv[0], delay='sys.argv[1]ms', loss=sys.argv[2], jitter='sys.argv[3]ms')
        #link with 100 Mbps BW, 50ms delay, 25% packet loss and 2ms jitter
        self.addLink(h2, s2, cls=TCLink, bw=sys.argv[4], delay='sys.argv[5]ms', loss=sys.argv[6], jitter='sys.argv[7]ms')
