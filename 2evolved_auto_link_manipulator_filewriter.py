...
def run():
    ...
    info(net['h1'].cmd('iperf -t 10 -c' net['r0'].IP() + '| tee -a test_output.txt'))
    info(net['h1_2'].cmd('iperf -t 10 -c' net['r0'].IP() + '| tee -a test_output.txt'))
    info(net['h1_3'].cmd('iperf -t 10 -c' net['r0'].IP() + '| tee -a test_output.txt'))
    info(net['h2'].cmd('iperf -t 10 -c' net['r0'].IP() + '| tee -a test_output.txt'))
    info(net['h2_2'].cmd('iperf -t 10 -c' net['r0'].IP() + '| tee -a test_output.txt'))
    info(net['h2_3'].cmd('iperf -t 10 -c' net['r0'].IP() + '| tee -a test_output.txt'))
