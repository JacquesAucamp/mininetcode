...
#Get User Choices
#----------------------------------------------------------------------------------------------
link_choice = input("Do you want to specify link parameters or make it random? Enter specify or random: ")
...
#--------------------------------------------------------------------------
if s == 1:
    str_arg1 = input("Enter Link 1 BW: ")
    str_arg2 = input("Enter Link 1 Delay: ")
    final_arg2 = "'" + str_arg2 + "ms" + "'"
    str_arg3 = input("Enter Link 1 Loss: ")
    str_arg4 = input("Enter Link 1 Jitter: ")
    final_arg4 = "'" + str_arg4 + "ms" + "'"

    str_arg5 = input("Enter Link 2 BW: ")
    str_arg6 = input("Enter Link 2 Delay: ")
    final_arg6 = "'" + str_arg6 + "ms" + "'"
    str_arg7 = input("Enter Link 2 Loss: ")
    str_arg8 = input("Enter Link 2 Jitter: ")
    final_arg8 = "'" + str_arg8 + "ms" + "'"

    str_arg9 = input("Enter Link 3 BW: ")
    str_arg10 = input("Enter Link 3 Delay: ")
    final_arg10 = "'" + str_arg10 + "ms" + "'"
    str_arg11 = input("Enter Link 3 Loss: ")
    str_arg12 = input("Enter Link 3 Jitter: ")
    final_arg12 = "'" + str_arg12 + "ms" + "'"

    str_arg13 = input("Enter Link 4 BW: ")
    str_arg14 = input("Enter Link 4 Delay: ")
    final_arg14 = "'" + str_arg14 + "ms" + "'"
    str_arg15 = input("Enter Link 4 Loss: ")
    str_arg16 = input("Enter Link 4 Jitter: ")
    final_arg16 = "'" + str_arg16 + "ms" + "'"

    str_arg17 = input("Enter Link 5 BW: ")
    str_arg18 = input("Enter Link 5 Delay: ")
    final_arg18 = "'" + str_arg18 + "ms" + "'"
    str_arg19 = input("Enter Link 5 Loss: ")
    str_arg20 = input("Enter Link 5 Jitter: ")
    final_arg20 = "'" + str_arg20 + "ms" + "'"

    str_arg21 = input("Enter Link 6 BW: ")
    str_arg22 = input("Enter Link 6 Delay: ")
    final_arg22 = "'" + str_arg22 + "ms" + "'"
    str_arg23 = input("Enter Link 6 Loss: ")
    str_arg24 = input("Enter Link 6 Jitter: ")
