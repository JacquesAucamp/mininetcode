...
def run():
    ...
    info(net['h1'].cmd('ping -c 10 %s' %net['r0'].IP() + '| tee -a test_output.txt'))
    ...
    info(net['h1'].cmd('iperf %s %d' %(net['h1'].IP(),net['r0'].IP()) + '| tee -a test_output.txt'))
    info(net['h'].cmd('iperf %s %d' %(net['h1'].IP(),net['r0'].IP()) + '| tee -a test_output.txt'))
