...
#Get User Choices
#----------------------------------------------------------------------------------------------
link_choice = raw_input("Do you want to specify link parameters or make it random? Enter specify or random: ")
print("You chose: %s" %link_choice)
if link_choice == 'specify':
    s = 1
elif link_choice == 'random':
    r = 1
#==============================================================================================
...
#--------------------------------------------------------------------------
if s == 1:
    str_arg1 = raw_input("Enter Link 1 BW: ")
    print("Link 1 BW = %s" %str_arg1)
    str_arg2 = raw_input("Enter Link 1 Delay: ")
    final_arg2 = "'" + str_arg2 + "ms" + "'"
    print("Link 1 Delay = %s" %final_arg2)
    str_arg3 = raw_input("Enter Link 1 Loss: ")
    str_arg4 = raw_input("Enter Link 1 Jitter: ")
    final_arg4 = "'" + str_arg4 + "ms" + "'"

    str_arg5 = raw_input("Enter Link 2 BW: ")
    str_arg6 = raw_input("Enter Link 2 Delay: ")
    final_arg6 = "'" + str_arg6 + "ms" + "'"
    str_arg7 = raw_input("Enter Link 2 Loss: ")
    str_arg8 = raw_input("Enter Link 2 Jitter: ")
    final_arg8 = "'" + str_arg8 + "ms" + "'"

    str_arg9 = raw_input("Enter Link 3 BW: ")
    str_arg10 = raw_input("Enter Link 3 Delay: ")
    final_arg10 = "'" + str_arg10 + "ms" + "'"
    str_arg11 = raw_input("Enter Link 3 Loss: ")
    str_arg12 = raw_input("Enter Link 3 Jitter: ")
    final_arg12 = "'" + str_arg12 + "ms" + "'"

    str_arg13 = raw_input("Enter Link 4 BW: ")
    str_arg14 = raw_input("Enter Link 4 Delay: ")
    final_arg14 = "'" + str_arg14 + "ms" + "'"
    str_arg15 = raw_input("Enter Link 4 Loss: ")
    str_arg16 = raw_input("Enter Link 4 Jitter: ")
    final_arg16 = "'" + str_arg16 + "ms" + "'"

    str_arg17 = raw_input("Enter Link 5 BW: ")
    str_arg18 = raw_input("Enter Link 5 Delay: ")
    final_arg18 = "'" + str_arg18 + "ms" + "'"
    str_arg19 = raw_input("Enter Link 5 Loss: ")
    str_arg20 = raw_input("Enter Link 5 Jitter: ")
    final_arg20 = "'" + str_arg20 + "ms" + "'"

    str_arg21 = raw_input("Enter Link 6 BW: ")
    str_arg22 = raw_input("Enter Link 6 Delay: ")
    final_arg22 = "'" + str_arg22 + "ms" + "'"
    str_arg23 = raw_input("Enter Link 6 Loss: ")
    str_arg24 = raw_input("Enter Link 6 Jitter: ")
...
if r == 1:
    ...
    jitter_list = ['1ms', '2ms', '3ms', '4ms', '5ms', '6ms']
...
class Net_Topology(Topo):
    ...
    def build(self, k = 2):
        ...
        if s == 1:
            self.addLink(h1, s1, cls=TCLink, bw=int(str_arg1), delay=final_arg2, loss=int(str_arg3), jitter=final_arg4)
            self.addLink(h1_2, s1, cls=TCLink, bw=int(str_arg5), delay=final_arg6, loss=int(str_arg7), jitter=final_arg8)
            self.addLink(h1_3, s1, cls=TCLink, bw=int(str_arg9), delay=final_arg10, loss=int(str_arg11), jitter=final_arg12)
            self.addLink(h2, s2, cls=TCLink, bw=int(str_arg13), delay=final_arg14, loss=int(str_arg15), jitter=final_arg16)
            self.addLink(h2_2, s2, cls=TCLink, bw=int(str_arg17), delay=final_arg18, loss=int(str_arg19), jitter=final_arg20)
            self.addLink(h2_3, s2, cls=TCLink, bw=int(str_arg21), delay=final_arg22, loss=int(str_arg23), jitter=final_arg24)
        elif r ==1:
